...
{
    public Task Handle(IMessageContext<TestMultipleEvent1> context, CancellationToken cancellationToken = default)
    {
    ...
    public Task Handle(IMessageContext<TestMultipleEvent2> context, CancellationToken cancellationToken = default)
    {
        TestStore.EventStore.Add(context.Message);
