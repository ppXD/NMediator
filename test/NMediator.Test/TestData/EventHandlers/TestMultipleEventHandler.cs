...
{
    public Task Handle(TestMultipleEvent1 @event, CancellationToken cancellationToken = default)
    {
        TestStore.Stores.Add(@event);
        return Task.CompletedTask;
    }

    public Task Handle(TestMultipleEvent2 @event, CancellationToken cancellationToken = default)
    {
        TestStore.Stores.Add(@event);
        return Task.CompletedTask;
    }
